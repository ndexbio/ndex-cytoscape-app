 ...
 * @author David
 */
public class UploadNetwork extends javax.swing.JDialog {

    /**
     * Creates new form UploadNetwork
     */
    public UploadNetwork(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jTextField1.setText("Default Network Name");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UploadNetwork.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UploadNetwork dialog = new UploadNetwork(new javax.swing.JFrame(), true);
