...
public final class CxExporter {
 ...
 /*   public final void setNextSuid(final long next_suid) {
    ...
    public final boolean writeNetwork(final CyNetwork network,
        ...
        ProvenanceEvent creationEvent = new ProvenanceEvent( "CyNDEx "+
        ...
        provenanceProps.add(new SimplePropertyValuePair ("cyNDEx Version", CyActivator.getAppVersion()));
 ...
 /*   private final static String getNameFromNodeTable(final CyNetwork network, final CyNode node) {
    ...
    private final void writeSubNetworks(final CyNetwork network,
		...
		if (write_siblings) {
	        ...
	        CyNetworkView view = org.cytoscape.ndex.internal.singletons.CyObjectManager.INSTANCE.getCurrentNetworkView();
            writeCartesianLayout(view, w, write_siblings, cxInfoHolder);
            writeVisualProperties(view, _visual_mapping_manager, _lexicon, w, write_siblings, cxInfoHolder);
		}
    }
